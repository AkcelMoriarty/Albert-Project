...
namespace EdgarDev.NPCTool.Utils
{
	...
	public class UtilNPC
	{
		...
		public static Color ICON_COLOR_STATIC_PATHPOINT = Color.red;
		public static Color ICON_COLOR_MULTI_PATHPOINT = Color.blue;
		public static Color ICON_COLOR_SELECTED_PATHPOINT = Color.white;
		public static Color LINE_COLOR_LOWEST_Y_PATHPOINT = Color.green;
		public static Color LINE_COLOR_HIGHEST_Y_PATHPOINT = Color.red;
		...
		public static NPC TryGetNPCFromSelection(GameObject[] selection)
		{
			...
			if (!isNPCParent)
			{
				...
				npc = selection[0].GetComponentInParent<NPC>(true);
