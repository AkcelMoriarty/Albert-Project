...
namespace EdgarDev.NPCTool
{
	...
	public class PathpointHandleEditor : Editor
	{
		...
		private static void DrawPathpointGUI(Vector3 pos)
		{
			// draw selected pathpoint
			Handles.color = UtilNPC.ICON_COLOR_SELECTED_PATHPOINT;
			Handles.SphereHandleCap(GUIUtility.GetControlID(FocusType.Passive), pos, Quaternion.identity, UtilNPC.ICON_SIZE_PATHPOINT, EventType.Repaint);
